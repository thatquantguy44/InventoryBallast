...
| T-010 | Add `formulation/multi_period.py::compile_multi_period_lp` tying T-007 through T-009 together; wire `mode="jointly_optimized"` result construction (reusing `domain/settlement.py` from T-005). | REQ-009 through REQ-012 | todo | No changes to `solvers/highs.py` or `validation/solution_verifier.py` — the `CompiledProblem` shape is structurally an ordinary LP. |
