...
T-009 are `done`; T-010 through T-014 are `todo` — resume at T-010** (`compile_multi_period_lp`/
`solve_multi_period`, tying T-007-T-009 together into the new, separate entry point).
