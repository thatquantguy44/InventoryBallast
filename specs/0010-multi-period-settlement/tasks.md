...
T-010 are `done`; T-011 through T-014 are `todo` — resume at T-011** (Phase 2's committed golden/
unit test fixtures; everything through `solve_multi_period` has so far only been verified via ad
hoc, uncommitted smoke scripts).
