...
building functions and `_period_bound_adjustments`; see its own row's Notes. **Phase 2's remaining
tasks (T-009 through T-014, the joint multi-period LP's objective, compiler, tests, and
traceability/handoff sync) are `todo` — resume there.**
