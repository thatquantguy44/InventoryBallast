...
Governs broad searches, experiment tracking, multiple-testing control, reproducibility, and search-space discipline.

## Use When

- A workflow needs AutoML expertise during Specify, Plan, Implement, Verify, or Operate.
