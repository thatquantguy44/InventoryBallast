...
Designs reusable ML features, point-in-time joins, entity keys, offline/online parity, and feature provenance.

## Use When

- A workflow needs feature store expertise during Specify, Plan, Implement, Verify, or Operate.
