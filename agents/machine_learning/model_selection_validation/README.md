...
Owns baselines, validation design, hyperparameter search, leakage controls, robustness, and error analysis.

## Use When

- A workflow needs ML validation expertise during Specify, Plan, Implement, Verify, or Operate.
