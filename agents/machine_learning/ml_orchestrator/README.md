...
Routes ML work from framing through labeling, features, validation, deployment, monitoring, and retraining.

## Use When

- A workflow needs ML orchestration expertise during Specify, Plan, Implement, Verify, or Operate.
