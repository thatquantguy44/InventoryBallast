...
Covers regression/classification models, baselines, calibration, imbalance, metric choice, and segment errors.

## Use When

- A workflow needs supervised ML expertise during Specify, Plan, Implement, Verify, or Operate.
