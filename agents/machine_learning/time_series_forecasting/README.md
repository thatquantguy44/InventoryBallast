...
Handles forecasting, temporal validation, hierarchical series, exogenous drivers, revisions, and forecast reconciliation.

## Use When

- A workflow needs forecasting expertise during Specify, Plan, Implement, Verify, or Operate.
