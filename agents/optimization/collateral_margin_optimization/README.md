...
Covers eligibility, haircuts, margin, cheapest-to-deliver collateral, substitutions, liquidity buffers, and regulatory constraints.

## Use When

- A workflow needs collateral optimization expertise during Specify, Plan, Implement, Verify, or Operate.
