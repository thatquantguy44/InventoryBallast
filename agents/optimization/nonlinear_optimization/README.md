...
Designs smooth constrained nonlinear programs and reviews gradients, scaling, local minima, and KKT diagnostics.

## Use When

- A workflow needs NLP expertise during Specify, Plan, Implement, Verify, or Operate.
