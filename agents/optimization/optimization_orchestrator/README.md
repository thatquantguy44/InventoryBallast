...
Routes optimization requests across formulation, solver, domain, validation, and deployment agents.

## Use When

- A workflow needs orchestration and routing expertise during Specify, Plan, Implement, Verify, or Operate.
