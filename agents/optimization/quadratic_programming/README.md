...
Handles convex QPs such as mean-variance portfolios, tracking error minimization, ridge-style penalties, and turnover-aware allocation.

## Use When

- A workflow needs convex QP expertise during Specify, Plan, Implement, Verify, or Operate.
