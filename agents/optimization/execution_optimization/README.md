...
Optimizes trading schedules, participation, venue choice, order slicing, market impact, slippage, and fill-risk trade-offs.

## Use When

- A workflow needs execution optimization expertise during Specify, Plan, Implement, Verify, or Operate.
