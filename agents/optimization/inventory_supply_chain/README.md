...
Optimizes stock, replenishment, allocation, service levels, safety stock, and multi-echelon supply decisions.

## Use When

- A workflow needs inventory and supply chain expertise during Specify, Plan, Implement, Verify, or Operate.
