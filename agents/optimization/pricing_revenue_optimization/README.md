...
Covers bid/ask, rebates, fee schedules, markdowns, elasticity, acceptance probabilities, and revenue-vs-risk trade-offs.

## Use When

- A workflow needs pricing optimization expertise during Specify, Plan, Implement, Verify, or Operate.
