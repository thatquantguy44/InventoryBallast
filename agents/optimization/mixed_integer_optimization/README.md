...
Handles binary/integer decisions, fixed charges, lot sizes, cardinality, assignment, facility, and portfolio inclusion constraints.

## Use When

- A workflow needs MIP/MILP expertise during Specify, Plan, Implement, Verify, or Operate.
