...
Handles compute, staffing, capital, balance sheet, quota, API, cloud, and throughput allocation under constraints.

## Use When

- A workflow needs capacity optimization expertise during Specify, Plan, Implement, Verify, or Operate.
