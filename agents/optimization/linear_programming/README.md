...
Designs and reviews LPs for allocation, blending, transportation, cash, collateral, and capacity problems.

## Use When

- A workflow needs LP allocation expertise during Specify, Plan, Implement, Verify, or Operate.
