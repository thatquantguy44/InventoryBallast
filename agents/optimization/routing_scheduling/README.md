...
Covers vehicle/job/crew scheduling, order routing, latency-aware placement, batching, and calendar/market-window constraints.

## Use When

- A workflow needs routing and scheduling expertise during Specify, Plan, Implement, Verify, or Operate.
