...
Designs uncertainty sets, worst-case constraints, stress-aware objectives, and robust counterparts for fragile estimates.

## Use When

- A workflow needs robust optimization expertise during Specify, Plan, Implement, Verify, or Operate.
