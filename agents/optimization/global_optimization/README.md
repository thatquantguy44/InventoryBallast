...
Covers nonconvex search, multi-start, branch-and-bound, Bayesian optimization, evolutionary methods, and heuristic baselines.

## Use When

- A workflow needs global search expertise during Specify, Plan, Implement, Verify, or Operate.
