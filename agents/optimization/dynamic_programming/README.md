...
Handles sequential decisions, Bellman recursions, approximate DP, inventory/rebalancing policies, and finite-horizon control.

## Use When

- A workflow needs dynamic programming expertise during Specify, Plan, Implement, Verify, or Operate.
