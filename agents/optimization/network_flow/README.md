...
Models min-cost flow, max-flow, matching, circulation, funding ladders, collateral chains, and graph-constrained routing.

## Use When

- A workflow needs network flow expertise during Specify, Plan, Implement, Verify, or Operate.
