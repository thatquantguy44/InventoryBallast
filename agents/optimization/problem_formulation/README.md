...
Turns an ambiguous business objective into variables, objective functions, constraints, data contracts, and acceptance criteria.

## Use When

- A workflow needs problem framing expertise during Specify, Plan, Implement, Verify, or Operate.
