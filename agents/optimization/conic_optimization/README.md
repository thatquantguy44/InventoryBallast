...
Covers SOCP/SDP-style risk, norm, robust, covariance, and chance-constraint formulations when linear or quadratic forms are too weak.

## Use When

- A workflow needs conic optimization expertise during Specify, Plan, Implement, Verify, or Operate.
