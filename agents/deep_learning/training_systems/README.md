...
Owns data loaders, distributed training, mixed precision, checkpointing, determinism, accelerators, and cost controls.

## Use When

- A workflow needs training systems expertise during Specify, Plan, Implement, Verify, or Operate.
