# Deep Model Compression And Serving

## Purpose

Owns distillation, quantization, pruning, batching, latency, memory, GPU utilization, and serving contracts.

## Use When

- A workflow needs compression/serving expertise during Specify, Plan, Implement, Verify, or Operate.
