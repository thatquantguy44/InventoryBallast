...
Designs embeddings, contrastive learning, similarity search, clustering, and representation evaluation.

## Use When

- A workflow needs representations expertise during Specify, Plan, Implement, Verify, or Operate.
