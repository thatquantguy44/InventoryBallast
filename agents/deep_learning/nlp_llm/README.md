...
Covers text classification, retrieval, embeddings, reranking, prompt/eval design, RAG boundaries, and LLM risk controls.

## Use When

- A workflow needs NLP/LLM expertise during Specify, Plan, Implement, Verify, or Operate.
