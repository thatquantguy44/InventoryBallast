...
Handles GNNs for networks, collateral chains, counterparties, supply graphs, ownership graphs, and message passing.

## Use When

- A workflow needs GNN expertise during Specify, Plan, Implement, Verify, or Operate.
