...
Covers tabular neural nets, embeddings, categorical features, calibration, baselines, and tabular-vs-tree trade-offs.

## Use When

- A workflow needs tabular DL expertise during Specify, Plan, Implement, Verify, or Operate.
