...
Designs temporal, transformer, attention, and sequence models for markets, logs, language, and operational streams.

## Use When

- A workflow needs transformers expertise during Specify, Plan, Implement, Verify, or Operate.
