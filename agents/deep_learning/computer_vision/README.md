...
Handles image/document/screenshot models, OCR-adjacent workflows, augmentation, labeling, and visual quality checks.

## Use When

- A workflow needs vision expertise during Specify, Plan, Implement, Verify, or Operate.
