...
Covers diffusion, VAEs, GANs, synthetic data, scenario generation, augmentation, and privacy/risk limits.

## Use When

- A workflow needs generative AI expertise during Specify, Plan, Implement, Verify, or Operate.
