...
Routes deep-learning work across architecture, data, training, evaluation, compression, serving, and monitoring.

## Use When

- A workflow needs DL orchestration expertise during Specify, Plan, Implement, Verify, or Operate.
